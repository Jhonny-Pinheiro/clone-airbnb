...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { address: @flat.address, bathroom: @flat.bathroom, description: @flat.description, guest: @flat.guest, image_url: @flat.image_url, room: @flat.room, user_id: @flat.user_id } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { address: @flat.address, bathroom: @flat.bathroom, description: @flat.description, guest: @flat.guest, image_url: @flat.image_url, room: @flat.room, user_id: @flat.user_id } }
